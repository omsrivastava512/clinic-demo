...
export const MOCK_PATIENT_PROFILES: PatientProfile[] = [
  ...
  // Aarav Mehta (uuid-p04) - A completely new patient with zero records for testing empty state fallbacks
  {
    ...
    // DECISION [ORIGIN: AI_AUTONOMOUS]: Set lastVisitAt to empty string to satisfy TypeScript string signature, safely parsed by getLastVisit().
    lastVisitAt: '',
    phone: '9000000004',
...
export const MOCK_PACKAGES: PackageRecord[] = [
  ...
  // User restructured clinic packages from session-count units to calendar-time units with complaint linking and Sunday toggles.
  {
    id: 'PKG-001',
    ...
    // DECISION [ORIGIN: AI_AUTONOMOUS]: Updated dates to 2026 to align with mock active timeline.
  ...
  },
  {
    ...
    // DECISION [ORIGIN: AI_AUTONOMOUS]: Updated dates to 2026 to align with mock active status.
  ...
  },
  {
    ...
    // DECISION [ORIGIN: AI_AUTONOMOUS]: Updated dates to 2026 to align with active status.
