        ...
        <div className="p-6 bg-white dark:bg-black transition-colors">
          ...
          <div className="flex gap-2 mb-6 items-end">
            ...
            <button
              ...
              className={`p-2 rounded-lg border transition-all mb-[1px] ${
                isNewCritical 
            ...
            <button 
              ...
              className="p-2 mb-[1px] bg-zinc-900 dark:bg-white text-white dark:text-black rounded-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
          ...
          <div className="space-y-2 max-h-[200px] overflow-y-auto mb-6 scrollbar-thin scrollbar-thumb-zinc-200 dark:scrollbar-thumb-zinc-800">
            ...
            {Object.entries(notes).map(([key, data]) => (
              ...
              >
                ...
                <button onClick={() => removeNote(key)} className="text-zinc-400 hover:text-red-600 dark:hover:text-red-400 transition-colors opacity-100 sm:opacity-0 sm:group-hover:opacity-100">
